...
ACLOCAL = ${SHELL} /mnt/hgfs/gui/usb/libusb-1.0/missing aclocal-1.15
AMTAR = $${TAR-tar}
AM_CFLAGS =  -Wall -Wundef -Wunused -Wstrict-prototypes -Werror-implicit-function-declaration -Wno-pointer-sign -Wshadow -pthread -fvisibility=hidden
AM_DEFAULT_VERBOSITY = 0
AR = ar
AUTOCONF = ${SHELL} /mnt/hgfs/gui/usb/libusb-1.0/missing autoconf
AUTOHEADER = ${SHELL} /mnt/hgfs/gui/usb/libusb-1.0/missing autoheader
AUTOMAKE = ${SHELL} /mnt/hgfs/gui/usb/libusb-1.0/missing automake-1.15
AWK = mawk
CC = gcc
...
LTLIBOBJS = 
LT_SYS_LIBRARY_PATH = 
MAKEINFO = ${SHELL} /mnt/hgfs/gui/usb/libusb-1.0/missing makeinfo
MANIFEST_TOOL = :
MKDIR_P = /bin/mkdir -p
NM = /usr/bin/nm -B
NMEDIT = 
...
STRIP = strip
VERSION = 1.0.23
abs_builddir = /mnt/hgfs/gui/usb/libusb-1.0
abs_srcdir = /mnt/hgfs/gui/usb/libusb-1.0
abs_top_builddir = /mnt/hgfs/gui/usb/libusb-1.0
abs_top_srcdir = /mnt/hgfs/gui/usb/libusb-1.0
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_CXX = g++
ac_ct_DUMPBIN = 
...
install_sh = ${SHELL} /mnt/hgfs/gui/usb/libusb-1.0/install-sh
